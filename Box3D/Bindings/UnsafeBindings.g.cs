...
namespace Box3D
{
    ...
    public static unsafe partial class Ffi
    {
        ...
        [DllImport(Box3DLibrary.Name, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int b3Body_CollideMover([NativeTypeName("b3BodyId")] BodyId bodyId, [NativeTypeName("b3BodyPlaneResult *")] BodyPlaneResult* bodyPlanes, int planeCapacity, B3Pos origin, [NativeTypeName("const b3Capsule *")] Capsule* mover, [NativeTypeName("b3QueryFilter")] QueryFilter filter, B3WorldTransform bodyTransform);
